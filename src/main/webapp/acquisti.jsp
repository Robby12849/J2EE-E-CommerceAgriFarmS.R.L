...
<ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
    ...
    <li class="dropdown"><a href="carrello.jsp">Carrello</a></li>
                            </ul>
...
<c:forEach var="acquisto" items="${acquisti}">
    <tr>
        <td>${acquisto.username}</td>
        <td>${acquisto.marca}</td>
        <td>${acquisto.famiglia}</td>
        <td>${acquisto.modello}</td>
        <td>${acquisto.costo}</td>
    </tr>
</c:forEach>        
                    </tbody>
                </table>
