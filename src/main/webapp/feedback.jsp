...
<ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
    ...
    <!-- End Breadcrumb -->
        ...
        <div class="login-page">
            <h1 align="center">Inserisci un nuovo Feedback</h1>
  <div class="form">
    <form class="login-form" action="validatelogin" method="post">
      		<input type="text" name="nome" id="nome" placeholder="Nome" required>
            <input type="text" name="cognome" id="cognome" placeholder="Cognome" required>
            <input type="text" name="acquisto" id="acquisto" placeholder="Acquisto" required>
            <input type="text" name="contenuto" id="contenuto" placeholder="Contenuto" required>
			<button type="submit" value="Inseriscifeed" id="inserisci" onclick="inserisci()">Inserisci </button>
    </form>
  </div>
</div>
    ...
    <div class="contact-area default-padding" style="background-image: url(assets/img/shape/28.png);">
        <div class="container">
            <div class="row align-center">
                    <h1 align="center">Opinioni dei Clienti</h1>
...
<script>
 async function inserisci() {
    ...
    var acquisto = document.getElementById("acquisto").value;
    var contenuto = document.getElementById("contenuto").value;
	var risp = await fetch("insertfeed?nome=" + nome + "&cognome="+ cognome + "&acquisto=" + acquisto + "&contenuto="+ contenuto ,{
		method : "POST"
	})
    if (risp.ok)
        alert("FEEDBACK INSERITO CORRETTAMENTE");
}
</script>
