...
<body>
   ...
   <ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
    ...
    <br>
    <center>
<form action="visualacquisti" action="POST">
<button class="btn btn-theme secondary btn-md radius animation" type="submit" name="acquisti" value="acquisti"> VISUALIZZA I TUOI VECCHI ACQUISTI</button>
</form>
<p>oppure</p>
<form action="visualizzacarrello" action="POST">
<button class="btn btn-theme secondary btn-md radius animation" type="submit" name="carrello" value="carrello"> Ritorna agli acquisti </button>
</form>
    </center>
